...
public class CalendarioDeleteArgs extends ServiceArgs implements Cloneable {
	...
	@Override
	public CalendarioDeleteArgs clone() {

		CalendarioDeleteArgs other = new CalendarioDeleteArgs();
