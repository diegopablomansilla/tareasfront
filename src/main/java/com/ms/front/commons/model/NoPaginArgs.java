...
public class NoPaginArgs extends ServiceArgs implements Cloneable {
	...
	@Override
	protected NoPaginArgs clone() {

		NoPaginArgs other = new NoPaginArgs();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NoPaginArgs other = (NoPaginArgs) obj;
		if (getDb() == null) {
			if (other.getDb() != null)
				return false;
